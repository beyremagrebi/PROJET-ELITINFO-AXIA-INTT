...
use App\Models\ElDemandevoiture;

class demandevoitureController extends Controller
{
    /**
    ...
    {
        $etape = DB::table('EL_FORMETAPES')->where('id_form', 11)->first();
        ...
        $rec=ElDemandevoiture::create([
             'nouveau'=>$request->checked,
             'typevoiture'=>$request->typevoiture,
