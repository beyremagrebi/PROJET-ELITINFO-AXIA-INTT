...
use App\Models\ElBoursejourneesience;

class boursejourneeController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $etape = DB::table('EL_FORMETAPES')->where('id_form', 5)->first();
        ...
        $rec=ElBoursejourneesience::create([
