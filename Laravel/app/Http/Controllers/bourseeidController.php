...
use App\Models\ElBourseeid;
class bourseeidController extends Controller
{
    /**
    ...
    {
        $etape = DB::table('EL_FORMETAPES')->where('id_form', 4)->first();
        ...
        $rec=ElBourseeid::create([
             'titreannee'=>$request->titreannee,
             'seul_identifiant'=>$request->seul_identifiant,
        ]);
      ElDemandes::create([
            'id_form'=>4,
           'id_doc'=>$rec->id,
