...
use App\Models\ElDemandemaladie;
class demandemaladieController extends Controller
{
    /**
    ...
    {
        $etape = DB::table('EL_FORMETAPES')->where('id_form', 12)->first();
        ...
        $rec=ElDemandemaladie::create([
             'typedemande'=>$request->selected,
             'raisonmaladie'=>$request->raisonmaladie,
