...
use App\Models\ElBoursecamp;
use App\Models\ElDemandes;

class boursecampController extends Controller
{
    /**
    ...
    {
        $etape = DB::table('EL_FORMETAPES')->where('id_form', 7)->first();
        ...
        $rec=ElBoursecamp::create([
             'montant'=>$request->montant,
             'soldeouverture'=>$request->solde,
             'soldeanneeencours'=>$request->soldeg
        ]);
      ElDemandes::create([
            'id_form'=>7,
           'id_doc'=>$rec->id,
